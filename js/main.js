let app = new Vue({
    ...
    computed: {
      ...
      favoriteRace() {
        let favorite = 'zerg'
        for (let i in this.totalGame) {
          if (this.totalGame[i] > this.totalGame[favorite]) {
            favorite = i
          }
        }
        return results[favorite].name
      },
      showResultRace() {
        return {
...
//       audio_btn = document.querySelector('.btn_sound'),
//       audio_icon = document.querySelector('.btn_sound i')
